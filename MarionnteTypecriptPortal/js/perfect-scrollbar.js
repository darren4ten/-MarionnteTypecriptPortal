  ...
  $.fn.perfectScrollbar = function (suppliedSettings, option) {
    ...
    return this.each(function () {
      ...
      function updateGeometry() {
        ...
        firstChild.css({ height: 'auto', width: 'auto' });
        ...
        if (scrollbarXActive) {
          ...
          firstChild.height(firstChild.height() - $this.find('.ps-scrollbar-x-rail').height());
        }
        if (scrollbarYActive) {
          $this.addClass('ps-active-y');
          firstChild.width(firstChild.width() - $this.find('.ps-scrollbar-y-rail').width());
        }
      }
